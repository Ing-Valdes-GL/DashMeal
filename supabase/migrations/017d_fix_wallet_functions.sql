...
BEGIN
  ...
  INSERT INTO platform_wallet_transactions (type, amount, balance_after, description, brand_id)
...
BEGIN
  ...
  INSERT INTO platform_wallet_transactions (type, amount, balance_after, description, campay_reference)
